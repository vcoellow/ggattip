...
;(function ($) {
	...
	prty = { 
        ...
        settings: { 
            //FLICKR API KEY
            Key: '88934c0d6b4cae1dd0211ee9aa1268af',
            //Secret
            Secret: 'e57f30410c9f84d5',
            //FLICKR user ID
            User: '62598014@N03',
            //Flickr PhotoSet ID
            PhotoSet: '72157684354968645',
            /*-- VIEWBOX SETTINGS --*/ 
        ...
        buildThumb: function() { 
            ...
            for(var i=0; i < prty.photoDetails.length; i++){
                ...
                thisItem = prty.galleryDiv.append("<li id="+i+"><a href='"+img.url_o+"'><img src='"+img.url_m+"' alt='"+img.title+"' /><div class='bg'></div><div class='content'></div><i class='show' data-href='"+img.url_o+"' data-photoid='"+img.id+"'>VER</i></a></li>").find('li .content').last();
